...
```sh
bin/prettiest theme gruvbox      # or catppuccin | tokyonight | mono
```
...
arm in `prettiest.sh` (BAT_THEME + fzf colors), and a `case` arm in `bin/prettiest` (`COLORWAYS`,
